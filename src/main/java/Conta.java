...
/**
 * Classe que representa uma conta bancária utilizando o framework Cucumber.
 * 
 * @author Lucas Kenzo Credendio Kuwajima
 * @version 1.0
 * @since 1.0
 */
public class Conta {

    private int saldo; // Atributo que armazena o saldo da conta
    private boolean isEspecial; // Atributo booleano que indica se é um usuário especial
    ...
    /**
     * Método que exibe mensagens caso o cliente seja especial e
    ...
    /**
     * Método que define o valor inicial da conta do cliente comum.
     *
    ...
    /**
     * Método que realiza um saque para o cliente comum.
     *
     * @param saque Valor a ser sacado.
     */
